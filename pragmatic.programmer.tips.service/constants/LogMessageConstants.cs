...
internal static class LogMessageConstants
{
    ...
    public const string InitializedPragmaticProgrammerTipsRepository =
        "initialized PragmaticProgrammerTipsRepository()";
    ...
    public const string GotEmailTemplateFromEmailTemplateRepository =
        "got email template from emailTemplateRepository.ReadFromRawEmailTemplateFileAsync()";

    public const string InitializedEmailService = "initialized EmailService(emailConfiguration)";

    public const string BuiltMimeMessageUsingEmailService =
        "built mime message using EmailService.BuildMimeMessageUsingHtml(...)";
